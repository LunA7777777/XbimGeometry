...
namespace Xbim . ModelGeometry . Scene
{
    ...
    public class Xbim3DModelContext
    {
        ...
        private class XbimProductBooleanInfo
        {
            ...
            public XbimProductBooleanInfo
            (
                    XbimCreateContextHelper contextHelper
                  , XbimGeometryEngine engine
                  , IModel model
                  , ConcurrentDictionary < int , bool > shapeIdsUsedMoreThanOnce
                  , IList < XbimShapeInstance > productShapes
                  , IList < XbimShapeInstance > cutToolIds
                  , IList < XbimShapeInstance > projectToolIds
                  , int context
                  , int styleId
            )
            {
                ...
                _productLabel = shape != null
                                        ? shape . IfcProductLabel
                                        : 0 ;


                _productType = shape != null
                                       ? shape . IfcTypeId
                                       : 0 ;
            ...
            )
            {
                ...
                foreach ( var argument in productShapes )
                {
                    ...
                    (
                            argument
                          , shapeIdsUsedMoreThanOnce . TryGetValue
                            (
                                    argument . ShapeGeometryLabel
                                  , out placebo
                            )
                    ) ;
                    ...
                    if ( geom != null )
                        ...
                        LogWarning
                        (
                                model . Instances [ argument . IfcProductLabel ]
                ...
                {
                    // makes copy if used more than once
                    bool makeCopy = shapeIdsUsedMoreThanOnce . TryGetValue
                    (
                            openingShape . ShapeGeometryLabel
                          , out placebo
                    ) ;


                    var openingGeom = contextHelper . GetGeometryFromCache
                    (
                            openingShape
                          , makeCopy
                    ) ;
                    ...
                    if ( openingGeom != null )
                        ...
                        LogWarning
                        (
                                model . Instances [ openingShape . IfcProductLabel ]
                              , "Some 3D geometric form definition is missing"
                        ) ;
                }
                ...
                {
                    var projGeom = contextHelper . GetGeometryFromCache
                    (
                            projectionShape
                          , shapeIdsUsedMoreThanOnce . TryGetValue
                            (
                                    projectionShape . ShapeGeometryLabel
                                  , out placebo
                            )
                    ) ;
                    ...
                    if ( projGeom != null )
                        ...
                        LogWarning
                        (
                                model . Instances [ projectionShape . IfcProductLabel ]
                              , "Some 3D geometric form definition is missing"
                        ) ;
                }
            }
        ...
        private class IfcRepresentationContextCollection : KeyedCollection < int , IIfcRepresentationContext >
        {
            ...
            (
                    IIfcRepresentationContext item
            )
            {
        ...
        private class XbimCreateContextHelper : IDisposable
        {
            ...
            public XbimCreateContextHelper
            (
                    IModel model
                  , IfcRepresentationContextCollection contexts
            )
            {
                Model = model ;
                Contexts = contexts ;
            ...
            /// </summary>
            internal ConcurrentDictionary < int , int > GeometryShapeLookup
            {
                get ;
            ...
            private IfcRepresentationContextCollection Contexts
            {
                get ;
            ...
            private HashSet < int > VoidedProductIds
            {
                get ;
            ...
            internal ConcurrentDictionary < int , IXbimGeometryObject > CachedGeometries
            {
                get ;
            ...
            internal ConcurrentDictionary < int , List < GeometryReference > > MapGeometryReferences
            {
                get ;
            ...
            internal ConcurrentDictionary < int , XbimMatrix3D > MapTransforms
            {
                get ;
            ...
            public MeshingBehaviourSetter customMeshBehaviour
            {
                get ;
            ...
            internal IXbimGeometryObject GetGeometryFromCache
            (
            ...
            )
            {
                ...
                if ( GeometryShapeLookup . TryGetValue
                    (
                    ...
                    ) )
                {
                    ...
                    if ( CachedGeometries . TryGetValue
                        (
                                ifcShapeId
                              , out obj
                        ) )
            ...
            )
            {
                try
                {
                    PlacementTree = new XbimPlacementTree
                    (
                            Model
                          , adjustWcs
                    ) ;
                    ...
                    foreach ( var voidedShapeId in OpeningsAndProjections . Select
                             (
                                     op => op . Key . EntityLabel
                             ) )
                        VoidedProductIds . Add
                        (
                                voidedShapeId
                        ) ;
                ...
                catch ( Exception e )
                {
                    LogError
                    (
                            "Unexpected failure during context initialisation"
                          , e
                    ) ;
            ...
            {
                Clusters
                        = new Dictionary < IIfcRepresentationContext ,
                                ConcurrentQueue < XbimBBoxClusterElement > > ( ) ;
                ...
                foreach ( var context in Contexts )
                    ...
                    (
                            context
                          , new ConcurrentQueue < XbimBBoxClusterElement > ( )
                    ) ;
            }
            ...
            private void GetOpeningsAndProjections ( )
            {
                ...
                var compoundElementsDictionary
                        = XbimMultiValueDictionary < IIfcObjectDefinition , IIfcObjectDefinition >
                ...
                foreach ( var aggRel in Model . Instances . OfType < IIfcRelAggregates > ( ) )
                {
                    ...
                    {
                        compoundElementsDictionary . Add
                        (
                                aggRel . RelatingObject
                              , relObj
                        ) ;
                    }
                }
                ...
                var openingRelations = Model
                                     . Instances
                                     . OfType < IIfcRelVoidsElement > ( )
                                     . Where
                                       (
                                               r =>
                                                       r . RelatingBuildingElement != null
                                                    && r . RelatingBuildingElement . Representation != null
                                                    && r . RelatedOpeningElement != null
                ...
                foreach ( var openingRelation in openingRelations )
                {
                    ...
                    if ( compoundElementsDictionary . TryGetValue
                        (
                                openingRelation . RelatingBuildingElement
                        ...
                        ) )
                    {
                        ...
                        (
                                childrenElements
                                      ...
                                      . Select
                                        (
                                                childElement => new ElementWithFeature ( )
                                                                {
                                                                        Element = childElement
                                                                      , Feature = openingRelation
                    ...
                    // process parent
                    elementsWithFeatures . Add
                    (
                            new ElementWithFeature ( )
                            {
                ...
                // projections
                var projectingRelations = Model
                                        . Instances
                                        . OfType < IIfcRelProjectsElement > ( )
                                        . Where
                                          (
                                                  r =>
                ...
                foreach ( var projectionRelation in projectingRelations )
                {
                    ...
                    if ( compoundElementsDictionary . TryGetValue
                        (
                                projectionRelation . RelatingElement
                              , out childrenElements
                        ) )
                    {
                        elementsWithFeatures . AddRange
                ...
                OpeningsAndProjections = elementsWithFeatures
                                       . GroupBy
                                         (
                                                 x => x . Element
                                               , y => y . Feature
            ...
            private void GetProductShapeIds ( )
            {
                ...
                foreach ( var product in Model
                                       ...
                                       . Where
                                         (
                                                 p => p . Representation != null
                                         ) )
                {
                    if ( customMeshBehaviour != null )
                    {
                        double v1 = 0
                             , v2 = 0 ; // v1 and v2 are ignored in this case


                        var behaviour = customMeshBehaviour
                        (
                                product . EntityLabel
                              , product . ExpressType . TypeId
                              , ref v1
                              , ref v2
                        ) ;
                    ...
                    var isVoidedProductShape = VoidedProductIds . Contains
                    (
                            product . EntityLabel
                    ) ;
                    ...
                    if ( product . Representation != null )
                    {
                        ...
                        {
                            foreach ( var shape in rep . Items . Where
                                     (
                                             i => ! ( i is IIfcGeometricSet )
                                     ) )
                            {
                                if ( shape is IIfcMappedItem mappedItem )
                                {
                                    ProcessMappedItem
                                    (
                                            isFeatureElementShape
                                          , isVoidedProductShape
                                          , mappedItem
                                    ) ;
                                }
                                else
                                {
                                    ...
                                    if ( isFeatureElementShape )
                                        FeatureElementShapeIds . Add
                                        (
                                                shape . EntityLabel
                                        ) ;


                                    if ( isVoidedProductShape )
                                        VoidedShapeIds . Add
                                        (
                                                shape . EntityLabel
                                        ) ;
            ...
            private void ProcessMappedItem
            (
                    bool isFeatureElementShape
                  , bool isVoidedProductShape
                  , IIfcMappedItem mappedItem
            )
            {
                MappedShapeIds . Add
                (
                        mappedItem . EntityLabel
                ) ;
                ...
                foreach ( var item in mappedItem . MappingSource . MappedRepresentation . Items )
                {
                    if ( item is IIfcMappedItem )
                        ...
                        (
                                isFeatureElementShape
                              , isVoidedProductShape
                              , item as IIfcMappedItem
                        ) ;
                    else if ( item != null
                           && ! ( item is IIfcGeometricSet ) )
                    {
        ...
        [ Obsolete ] private XbimGeometryEngine Engine
        {
            get
            {
                return _engine ?? ( _engine = new XbimGeometryEngine ( ) ) ;
            }
        }
        ...
        )
        {
            if ( _logger != null )
            {
                ...
                if ( entity is IPersistEntity ifcEntity )
                    _logger . LogWarning
                    (
                            "GeomScene: #{entityLabel}={entityType} [{message}]"
        ...
        )
        {
            ...
            var parentContexts = builtContextList
                               . OfType < IIfcGeometricRepresentationSubContext > ( )
                               . Select
                                 (
                                         x => x . ParentContext
                                 )
                               . Distinct ( )
                               . ToList ( ) ; // tolist is needed to prevent collection change.
            ...
            if ( requiredContextIdentifier != null
              && contexts . Any ( ) )
                    ...
                    //filter on the identifier if defined and we have more than one model context
            {
                var subContexts =
                        contexts
                              . Where
                                (
                                        c => c . ContextIdentifier . HasValue
                                          && requiredContextIdentifier
                                           . ToLower ( )
                                           . Contains
                                             (
                                                     c
            ...
            if ( ! contexts . Any ( ) )
            {
                ...
                if ( contexts . Any ( ) )
                {
                    ...
                    (
                          ...
                          , string . Join
                            (
                                    ","
                                  , model . Header . FileSchema . Schemas
                            )
                    ) ;
                }
                else
                {
                    ...
                    if ( contexts . Any ( ) )
                    {
                        var ctxtString = contexts . Aggregate
                        (
                                ""
                               ,
                                (
        ...
        )
        {
            _logger . LogInformation
            (
                    "Starting creation of model scene"
            ) ;
              ...
              || Engine == null )
            {
                _logger . LogWarning
                (
                        "No model context instance or model engine found. Finishing..."
                ) ;
            ...
            if ( geometryStore == null )
            {
                _logger . LogWarning
                (
                        "No GeometryStore in model. Finishing..."
                ) ;
            ...
            using ( var geometryTransaction = geometryStore . BeginInit ( ) )
            {
                if ( geometryTransaction == null )
                {
                    _logger . LogWarning
                    (
                            "No Transaction created. Finishing..."
                    ) ;
                ...
                using ( var contextHelper = new XbimCreateContextHelper
                       (
                               _model
                             , _contexts
                       ) )
                {
                    ...
                    if ( ! contextHelper . Initialise
                        ...
                        throw new Exception
                        (
                                "Failed to initialise geometric context, " + contextHelper . InitialiseError
                        ) ;
                    ...
                    // process features
                    var processed = WriteProductsWithFeatures
                    (
                            contextHelper
                          , progDelegate
                          , geomStorageType
                    ...
                    foreach ( var cluster in contextHelper . Clusters )
                    {
                        ...
                        (
                              ...
                              , cluster . Value
                              , geometryTransaction
                              , contextHelper . PlacementTree . WorldCoordinateSystem
                        ) ;
                    }
            ...
            _logger . LogInformation
            (
                    "Finished creation of model scene"
            ) ;
        ...
        public delegate MeshingBehaviourResult MeshingBehaviourSetter
        (
                int elementId
              , int typeId
              , ref double linearDeflection
        ...
        )
        {
            ...
            if ( progDelegate != null )
                ...
                (
                        - 1
                      , "WriteFeatureElements (" + contextHelper . OpeningsAndProjections . Count + " elements)"
                ) ;
            ...
            var openingAndProjectionOps
                    = new ConcurrentBag <
                            XbimProductBooleanInfo > ( ) ; // prepares the information to perform the openings and projections
            ...
            Parallel . ForEach
            (
                    contextHelper . OpeningsAndProjections
                  , contextHelper . ParallelOptions
                  , elementToFeatureGroup =>
                            ...
                            // foreach (IGrouping<IIfcElement, IIfcFeatureElement> pair in contextHelper.OpeningsAndProjections)
                    {
                        ...
                        //
                        var elementShapes = WriteProductShape
                        (
                                contextHelper
                              , element
                              , false
                        ...
                        {
                            if ( ! allShapeIds . TryAdd
                                 (
                                         elemShape . ShapeGeometryLabel
                                       , true
                                 ) )
                                shapeIdsUsedMoreThanOnce . TryAdd
                                (
                                        elemShape . ShapeGeometryLabel
                                      , true
                                ) ;
                        ...
                        if ( productShapes . Count > 0 )
                        {
                            ...
                            foreach ( var feature in elementToFeatureGroup )
                            {
                                ...
                                var featureShapes = WriteProductShape
                                (
                                        contextHelper
                                      , feature
                                      , false
                                ...
                                foreach ( var featureShape in featureShapes )
                                {
                                    if ( ! allShapeIds . TryAdd
                                         (
                                                 featureShape . ShapeGeometryLabel
                                               , true
                                         ) )
                                        shapeIdsUsedMoreThanOnce . TryAdd
                                        (
                            ...
                            var boolOp = new XbimProductBooleanInfo
                            (
                                    contextHelper
                                  , Engine
                                  , Model
            ...
            Parallel . ForEach
            (
                    openingAndProjectionOps . OrderByDescending
                    (
                            b => b . CutGeometries . Count + b . ProjectGeometries . Count
                    )
                  , contextHelper . ParallelOptions
                  , openingAndProjectionOp =>
                    {
                        ...
                        try
                        {
                            if ( progDelegate != null )
                            {
                                var newPercentage = Convert . ToInt32
                                (
                                        ( double ) localTally / featureCount * 100.0
                                ) ;
                            ...
                            {
                                behaviour = CustomMeshingBehaviour
                                (
                                        elementLabel
                                      , typeId
                                      , ref thisDeflectionDistance
                            ...
                            if ( behaviour . HasFlag
                                 (
                                         MeshingBehaviourResult . PerformAdditions
                                 )
                              && openingAndProjectionOp . ProjectGeometries . Any ( ) )
                            {
                                var nextGeom = elementGeom . Union
                                (
                                        openingAndProjectionOp . ProjectGeometries
                                      , precision
                                ) ;
                                ...
                                if ( nextGeom . IsValid )
                                {
                                    if ( nextGeom . First != null
                                      && nextGeom . First . IsValid )
                                        elementGeom = nextGeom ;
                                    else
                                        LogWarning
                                        (
                                                _model . Instances [ elementLabel ]
                                              , "Projections are an empty shape"
                                        ) ;
                                }
                                else
                                    LogWarning
                            ...
                            if ( behaviour . HasFlag
                                 (
                                         MeshingBehaviourResult . PerformSubtractions
                                 )
                              && openingAndProjectionOp . CutGeometries . Any ( ) )
                            {
                                ...
                                try
                                {
                                    ...
                                    nextGeom = elementGeom . Cut
                                    (
                                            openingAndProjectionOp . CutGeometries
                                          , precision
                                    ) ;
                                ...
                                catch ( TimeoutException )
                                {
                                    ...
                                    (
                                            _model . Instances [ elementLabel ]
                                          , "Cutting openings has failed. Openings have been ignored. Operation timed out after {0} seconds"
                            ...
                            foreach ( var geom in elementGeom )
                            {
                                ...
                                if ( geomType == XbimGeometryType . PolyhedronBinary )
                                {
                                    ...
                                    {
                                        Engine . WriteTriangulation
                                        (
                                                bw
                                              , geom
                                              , mf . Precision
                                              , thisDeflectionDistance
                                              , thisDeflectionAngle
                                        ) ;
                                    }
                                }
                                ...
                                if ( shapeGeometry . ShapeData . Length > 0 )
                                {
                                    var shapeInstance = new XbimShapeInstance
                                                        {
                                                              ...
                                                              , /* This gets Set to appropriate value a few lines below */ StyleLabel
                                                                        = openingAndProjectionOp . StyleId
                                                              , RepresentationType
                                                                        = XbimGeometryRepresentationType
                                                                              . OpeningsAndAdditionsIncluded
                                                              , RepresentationContext
                                                                        = openingAndProjectionOp . ContextId
                                    ...
                                    shapeInstance . ShapeGeometryLabel = txn . AddShapeGeometry
                                    (
                                            shapeGeometry
                                    ) ;


                                    txn . AddShapeInstance
                                    (
                                            shapeInstance
                                          , shapeInstance . ShapeGeometryLabel
                                    ) ;
                        ...
                        catch ( Exception e )
                        {
                            ...
                            (
                                    _model . Instances [ elementLabel ]
                                  , "Contains openings but  its basic geometry can not be built, {0}"
                                  , e . Message
                            ) ;
                        }
            ...
            if ( progDelegate != null )
                ...
                (
                        101
                      , "WriteFeatureElements, (" + localTally + " written)"
                ) ;
        ...
        private XbimMatrix3D ApplyShapeDisplacement
        (
                GeometryReference shape
              , XbimMatrix3D transformation
        )
        {
            ...
            var translation = XbimMatrix3D . CreateTranslation
            (
                    shape . LocalShapeDisplacement . Value
            ) ;


            return XbimMatrix3D . Multiply
            (
                    translation
                  , transformation
            ) ;
        ...
        (
                XbimCreateContextHelper contextHelper
              , IEnumerable < IIfcProduct > products
              , IGeometryStoreInitialiser txn
        )
        {
            ...
            {
                if ( contextHelper . ShapeLookup . TryGetValue
                     (
                             grid . EntityLabel
                           , out GeometryReference instance
                     )
                  && grid . Representation != null
                  && grid . Representation . Representations . Count > 0 )
                {
                    XbimMatrix3D placementTransform = XbimPlacementTree . GetTransform
                    (
                            grid
                          , contextHelper . PlacementTree
                          , Engine
                    ) ;


                    placementTransform = ApplyShapeDisplacement
                    (
                            instance
                          , placementTransform
                    ) ;
                  ...
                  , product =>
                    {
                        ...
                        // Write product representations of context
                        if ( product . Representation . Representations . Any
                            (
                                    r => IsInContext
                                         (
                                                 _contexts
        ...
        )
        {
            ...
            if ( r . ContextOfItems == null )
            {
                ...
                (
                        r
                      , "No Context found for this representation"
                ) ;
        ...
        )
        {
            if ( CustomMeshingBehaviour != null )
            {
                ...
                var behaviour = CustomMeshingBehaviour
                (
                        product . EntityLabel
                      , product . ExpressType . TypeId
                      , ref v1
            ...
            var reps = product . Representation . Representations . Where
            (
                    r => IsInContext
                         (
                                 _contexts
            ...
            // transform setup
            var placementTransform = XbimPlacementTree . GetTransform
            (
                    product
                  , contextHelper . PlacementTree
                  , Engine
            ...
            return reps
                 . SelectMany
                   (
                           r => WriteProductShapeRepresentationItems
                           (
                                   contextHelper
                                 , product
                                 , txn
        ...
        private List < XbimShapeInstance > WriteProductShapeRepresentationItems
        (
                XbimCreateContextHelper contextHelper
              , IIfcProduct product
              , IGeometryStoreInitialiser txn
              , IIfcRepresentation rep
        ...
        )
        {
            ...
            if ( rep . ContextOfItems == null )
            {
                ...
                (
                        product
                      , "Unable to write representation because no ContextOfItems was provided for representation {0}"
                      , rep . EntityLabel
                ) ;
            ...
            foreach ( var representationItem in representationItems )
            {
                if ( representationItem is IIfcMappedItem theMap )
                {
                    ...
                    //
                    if ( contextHelper . MapGeometryReferences . TryGetValue
                        (
                                mapId
                              , out List < GeometryReference > mapGeomIds
                        ) )
                            ...
                            //if we have something to write                           
                    {
                        ...
                        {
                            var trans = XbimMatrix3D . Multiply
                            (
                                    mapTransform
                                  , placementTransform
                            ) ;
                            ...
                            trans = ApplyShapeDisplacement
                            (
                                    mappedGeometryReference
                                  , trans
                            ) ;
                            ...
                            (
                                    WriteShapeInstanceToStore
                                    (
                                            mappedGeometryReference . GeometryId
                                          , mappedGeometryReference . StyleLabel
                                          , contextId
                                          , product
                                          , trans
                            ...
                            if ( ! ( product is IIfcOpeningElement ) )
                            {
                                ...
                                var transformedProductBounds = mappedGeometryReference . BoundingBox . Transform
                                (
                                        trans
                                ) ;
                                ...
                                contextHelper
                                      . Clusters [ rep . ContextOfItems ]
                                      . Enqueue
                                        (
                                                new XbimBBoxClusterElement
                                                (
                                                        mappedGeometryReference . GeometryId
                                                      , transformedProductBounds
                                                )
                                        ) ;
                            }
                        }
                    ...
                    else
                    {
                        ...
                        //
                        if ( contextHelper . MapTransforms . TryGetValue
                            (
                                    mapId
                                  , out XbimMatrix3D trs
                            ) )
                        {
                            var mapTransform = contextHelper . MapTransforms [ mapId ] ;
                            ...
                            (
                                    WriteProductShapeRepresentationItems
                                    (
                                            contextHelper
                                          , product
                                          , txn
                ...
                else //it is a direct reference to geometry shape
                {
                    if ( contextHelper . ShapeLookup . TryGetValue
                        (
                                representationItem . EntityLabel
                              , out GeometryReference instance
                        ) )
                    {
                        var trans = ApplyShapeDisplacement
                        (
                                instance
                              , placementTransform
                        ) ;
                        ...
                        (
                                ...
                                (
                                      ...
                                      , product
                                      , trans
                                      , instance . BoundingBox /*productBounds*/
                                      , repType
                                      , txn
                                )
                        ) ;
                        ...
                        {
                            // transform the bounds
                            var transproductBounds = instance . BoundingBox . Transform
                            (
                                    trans
                            ) ;
        ...
        private void PrepareMapGeometryReferences
        (
                XbimCreateContextHelper contextHelper
              , ReportProgressDelegate progDelegate
        )
        {
            ...
            (
                    - 1
                  , "WriteMappedItems (" + contextHelper . MappedShapeIds . Count + " items)"
            ) ;


            Parallel . ForEach
            (
                    contextHelper . MappedShapeIds
                  , contextHelper . ParallelOptions
                  , mapId =>
                    {
                        ...
                        if ( ! ( entity is IIfcMappedItem map ) )
                        {
                            LogError
                            (
                                    _model . Instances [ entity . EntityLabel ]
                                  , "Is an illegal entity in maps collection"
                            ) ;
                        ...
                        foreach ( var mapShape in map . MappingSource . MappedRepresentation . Items )
                        {
                            ...
                            if ( contextHelper . ShapeLookup . TryGetValue
                                (
                                        mapShapeLabel
                                      , out GeometryReference mapGeometryRef
                                ) )
                            {
                            ...
                            else if ( ! ( mapShape is IIfcGeometricSet )
                                   && ! ( mapShape is IIfcMappedItem ) ) //ignore non solid geometry sets //it might be a map
                            {
                                LogWarning
                                (
                                        _model . Instances [ mapShape . EntityLabel ]
                                      , "Failed to find shape in map"
                                ) ;
                            }
                        }
                        ...
                        {
                            contextHelper . MapGeometryReferences . TryAdd
                            (
                                    map . EntityLabel
                                  , mapShapes
                            ) ;
                        ...
                        contextHelper . MapTransforms . TryAdd
                        (
                                map . EntityLabel
            ...
            (
                    101
                  , "WriteMappedItems, (" + contextHelper . MappedShapeIds . Count + " written)"
            ) ;
        }


        private bool GetStyleId
        (
                XbimCreateContextHelper contextHelper
              , int shapeId
              , out int styleId
        ...
        {
            if ( contextHelper . SurfaceStyles . TryGetValue
                (
                        shapeId
                      , out styleId
                ) )
            ...
            var stack = new Stack < IIfcBooleanOperand >
            (
                    operands
            ) ;
        ...
        )
        {
            ...
            // var dedupCount = 0;
            var xbimTessellator = new XbimTessellator
            (
                    Model
                  , geomStorageType
            ) ;
            ...
            if ( progDelegate != null )
                ...
                (
                        - 1
                      , "WriteShapeGeometries (" + contextHelper . ProductShapeIds . Count + " shapes)"
                ) ;
            ...
            foreach ( var grid in Model . Instances . OfType < IIfcGrid > ( ) )
            {
                using ( var geomModel = Engine . CreateGrid
                       (
                               grid
                             , _logger
                       ) )
                {
                    if ( geomModel != null
                      && geomModel . IsValid )
                    {
                        var shapeGeom = Engine . CreateShapeGeometry
                        (
                                geomModel
                              , precision
                              , deflection
                        ...
                        var refCounter = new GeometryReference
                                         {
                                               ...
                                               , GeometryId = geometryStore . AddShapeGeometry
                                                 (
                                                         shapeGeom
                                                 )
                                                ,
                        ...
                        contextHelper . ShapeLookup . TryAdd
                        (
                       ...
                       ,
                        ...
                        ) =>
                        {
                            ...
                            catch ( Exception ex )
                            {
                                ...
                                (
                                        "Error getting IIfcGeometricRepresentationItem for EntityLabel #{0}. Geometry Ignored."
                                      , shapeId
                                ) ;
                            ...
                            if ( shape == null )
                            {
                                var errmsg = string . Format
                                (
                                        "IIfcGeometricRepresentationItem for EntityLabel #{0} not found. Geometry Ignored."
                                      , shapeId
                                ) ;
                            ...
                            var isFeatureElementShape = contextHelper . FeatureElementShapeIds . Contains
                            (
                                    shapeId
                            ) ;


                            var isVoidedProductShape = contextHelper . VoidedShapeIds . Contains
                            (
                                    shapeId
                            ) ;
                            ...
                            if ( ! isFeatureElementShape
                              && ! isVoidedProductShape
                              && xbimTessellator . CanMesh
                                 (
                                         shape
                                 ) ) // if we can mesh the shape directly just do it
                            {
                                shapeGeom = xbimTessellator . Mesh
                                (
                                        shape
                                ) ;
                            }
                            else //we need to create a geometry object
                            {
                                ...
                                catch ( XbimGeometryFaceSetTooLargeException fse )
                                {
                                    ...
                                    _logger . LogWarning
                                    (
                                            "Large Face Set #{0} {1} detected and handled as Mesh"
                                          , faceSetEntityLabel
                                          , faceSetEntityType
                                    ) ;
                                    ...
                                    shapeGeom = xbimTessellator . Mesh
                                    (
                                            ( IIfcRepresentationItem ) Model . Instances [ faceSetEntityLabel ]
                                    ) ;
                                }
                                ...
                                if ( geomModel != null
                                  && geomModel . IsValid )
                                {
                                    shapeGeom = Engine . CreateShapeGeometry
                                    (
                                            geomModel
                                          , precision
                                          , deflection
                                    ...
                                    if ( isFeatureElementShape )
                                    {
                                        ...
                                        if ( geomSet != null )
                                        {
                                            ...
                                            contextHelper . CachedGeometries . TryAdd
                                            (
                                                    shapeId
                                                  , solidSet
                                            ) ;
                            ...
                            if ( shapeGeom == null
                              || shapeGeom . ShapeData == null
                              || shapeGeom . ShapeData . Length == 0 )
                                LogInfo
                                (
                                        _model . Instances [ shapeId ]
                                      , "Is an empty shape"
                                ) ;
                            else
                            {
                                ...
                                if ( contextHelper . CachedGeometries . ContainsKey
                                    (
                                            shapeGeom . IfcShapeLabel
                                    ) )
                                {
                                    //keep a record of the IFC label and database record mapping
                                    contextHelper . GeometryShapeLookup . TryAdd
                                    (
                                            shapeGeom . ShapeLabel
                                          , shapeGeom . IfcShapeLabel
                                    ) ;
                                }
                            ...
                            if ( progDelegate != null )
                            {
                                var newPercentage = Convert . ToInt32
                                (
                                        ( double ) localTally / contextHelper . Total * 100.0
                                ) ;
            ...
            catch ( AggregateException e )
            {
                ...
                throw new XbimException
                (
                        "Processing halted due to model error"
                      , e
                ) ;
            }
            ...
            Debug . Assert
            (
                    contextHelper . ProductShapeIds . Count == processed . Count
            ) ;
            ...
            if ( progDelegate != null )
                ...
                (
                        101
                      , "WriteShapeGeometries, (" + localTally + " written)"
                ) ;
        }
        ...
        (
                IIfcGeometricRepresentationItem shape
              , ILogger logger
              , int booleanTimeOutMilliSeconds
        )
        {
            ...
            Func < IXbimGeometryObject > wrappedAction = ( ) =>
                                                         {
                                                             ...
                                                             catch ( ThreadAbortException )
                                                             {
                                                                 _logger . LogWarning
                                                                 (
                                                                         "Thread aborted due to timeout"
                                                                 ) ;


                                                                 Thread
                                                                       . ResetAbort ( ) ; // cancel hard aborting, lets to finish it nicely.
            ...
            IAsyncResult result = wrappedAction . BeginInvoke
            (
                    null
                  , null
            ) ;
            ...
            if ( result . AsyncWaitHandle . WaitOne
                (
                        booleanTimeOutMilliSeconds
                ) )
            {
                var res = wrappedAction . EndInvoke
                (
                        result
                ) ;
        ...
        private IXbimGeometryObjectSet CutWithTimeOut
        (
                IXbimGeometryObjectSet elementGeom
              , IXbimSolidSet cutGeometries
              , double precision
              , int booleanTimeOutMilliSeconds
        )
        {
        ...
        private void WriteRegionsToStore
        (
                IIfcRepresentationContext context
        ...
        /// </summary>
        /// <returns></returns>
        private XbimShapeInstance WriteShapeInstanceToStore
        (
                int shapeLabel
              , int styleLabel
              , int ctxtId
        ...
        )
        {
            var shapeInstance = new XbimShapeInstance
                                {
                                      ...
                                      , IfcTypeId = _model . Metadata . ExpressTypeId
                                        (
                                                product
                                        )
            ...
            catch ( Exception e )
            {
                LogError
                (
                        _model . Instances [ product . EntityLabel ]
                      , "Failed to create geometry, {0}"
                      , e . Message
                ) ;
            }
        ...
        public XbimShapeGeometry ShapeGeometry
        (
        ...
        /// <returns></returns>
        public IEnumerable < XbimShapeInstance > ShapeInstancesOf
        (
        ...
        )
        {
            using ( var reader = _model . GeometryStore . BeginRead ( ) )
            {
                foreach ( var context in _contexts )
                {
                    foreach ( var shapeInstance in reader . ShapeInstancesOfGeometry
                             (
                                     geometry . ShapeLabel
                             ) )
                    {
                        if ( ! MatchesShapeRequirements
                             (
                                     shapeInstance
                                   , context
                                   , ignoreFeatures
        ...
        private bool MatchesShapeRequirements
        (
        ...
        )
        {
            return context . EntityLabel == shapeInstance . RepresentationContext
                && // all must belong to relevant RepresentationContext
                   (
                       ( typeof ( IIfcFeatureElement ) . IsAssignableFrom
                         (
                                 _model . Metadata . GetType
                                 (
                      ...
                      == ( byte ) XbimGeometryRepresentationType
                               . OpeningsAndAdditionsOnly ) // then look for feature shape
                     ||
        ...
        )
        {
            using ( var reader = _model . GeometryStore . BeginRead ( ) )
            {
                foreach ( var context in _contexts )
                {
                    foreach ( var shapeInstance in reader . ShapeInstancesOfEntity
                             (
                                     product
                             ) )
                    {
        ...
        /// </summary>
        /// <returns></returns>
        public IXbimMeshGeometry3D ShapeGeometryMeshOf
        (
                int shapeGeometryLabel
        )
        {
            var sg = ShapeGeometry
            (
                    shapeGeometryLabel
            ) ;
